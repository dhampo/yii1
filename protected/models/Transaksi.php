...
class Transaksi extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_transaksi, nama_barang, qty, total_harga', 'required'),
			array('id_transaksi, qty', 'numerical', 'integerOnly'=>true),
			array('nama_barang', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_transaksi, nama_barang, qty, total_harga', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'Barang' => array(self::BELONGS_TO, 'nama_barang', 'nama_barang'),
		);
	}
